...
// Layout
import { LayoutConfigService, MenuAsideService, MenuOptions, OffcanvasOptions, MenuConfigService } from '../../../core/_base/layout';
...
export class AsideLeftComponent implements OnInit, AfterViewInit {
	...
	getallSection(){
		this.sec.getallSections().subscribe(
		  data=>{this.listSections=data
		console.log(data)}
